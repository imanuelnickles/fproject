      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ asset('plugin/dist/img/user3-128x128.jpg') }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ asset('plugin/dist/img/user4-128x128.jpg') }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('plugin/dist/img/user2-160x160.jpg') }}" class="user-image" alt="User Image">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="{{ asset('plugin/dist/img/user4-128x128.jpg') }}" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="{{ asset('plugin/dist/img/user3-128x128.jpg') }}" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="{{ asset('plugin/dist/img/user2-160x160.jpg') }}" alt="user image" class="offline">
